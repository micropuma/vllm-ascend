...
# ║  Server scripts use `export VAR=${VAR:-default}` — overrides here take      ║
# ║  precedence over the scripts' defaults.                                     ║
# ╚══════════════════════════════════════════════════════════════════════════════╝

# ── Case 1 ─────────────────────────────────────────────────────────────────────
CASE1_LABEL="${CASE1_LABEL:-baseline}"
CASE1_SERVER="${CASE1_SERVER:-Qwen3-30B-server.sh}"
declare -a CASE1_ENV=(
...
CASE2_SERVER="${CASE2_SERVER:-Qwen3-30B-dbo-server.sh}"
...
LABEL="$CASE1_LABEL" PORT="$PORT" bash "$SCRIPT_DIR/Qwen3-30B-dbo-test.sh"
...
LABEL="$CASE2_LABEL" PORT="$PORT" bash "$SCRIPT_DIR/Qwen3-30B-dbo-test.sh"
